...
Otherwise the cell says "Not in sources at this leaf ratio". A source that
...
- **N**: not in sources; the cell says so.
...
| Moonlight | Flask subsequent | Not in sources | — | N |
...
| Peony | Wash | Not in sources | — | N |
| Peony | Flask | 3–4 min; subsequent N | Curious-BMD | R |
| Peony | Gaiwan | 20 s; longer each time; count N | Curious-BMD (1:33, within 1.5× of 1:24) | R |
...
| Jasmine white | Flask | 3–4 min; subsequent N | Sar-white scented (1:95) | R |
| Jasmine white | Gaiwan | Not in sources at this leaf ratio | Chayu scented is 1:50, 2.1× the gaiwan's 1:24 | N |
...
| Lily, Rose black | Teapot | Not in sources at this leaf ratio | Chayu whole-leaf 1:30 (1.67× off); broken 1:50 is one steep | N |
...
- **Principles by tea type**: each row's Basis cell holds its sources; the
  unsourced Notes column and "general practice" values were removed.
